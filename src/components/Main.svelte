<script>
    ...
    let benefits = [
        ...
        },
        {
            ...
            description:
                "Communication is essential, a core value that I hold in high regard. My unwavering commitment to transparency and positive dialogue enables me to cultivate meaningful relationships and excel in productivity within various work environments and teams.",
        },
    ];
</script>
    ...
    >
        ...
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hello! I'm <span class="poppins text-violet-400">Pierson </span> Alexander
                <br />Digital/Data
                <span class="poppins text-violet-400">Analyst</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My expertise is in <span class="text-violet-400"> Google Tag Manager(GTM) & Google Analytics 4(GA4)</span>. I specialize in leveraging data for insightful web
                 analytics.
        ...
        <div class="relative shadow-2xl grid place-items-center">
            <img
                src={"images/Professional_NB.png"}
                alt="Zetane Engine"
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        <div class="flex flex-col gap-2 text-center">
            <h6 class="text-large sm:text-xl md:text-2xl">
                A couple of my creative pursuits.
            </h6>
